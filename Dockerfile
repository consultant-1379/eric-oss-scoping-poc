...
CMD ["/bin/sh", "-c", "java ${JAVA_OPTS} -Dcom.sun.management.jmxremote=true \
    ...
    -jar eric-oss-scoping-poc-app.jar"]
...
LABEL \
    org.opencontainers.image.title=eric-oss-scoping-poc-jsb \
