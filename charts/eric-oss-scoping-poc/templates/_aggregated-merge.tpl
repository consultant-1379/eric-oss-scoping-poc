...
*/ -}}
{{- define "eric-oss-scoping-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-scoping-poc.mergeAnnotations" -}}
  {{- include "eric-oss-scoping-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-scoping-poc.mergeLabels" -}}
  {{- include "eric-oss-scoping-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
